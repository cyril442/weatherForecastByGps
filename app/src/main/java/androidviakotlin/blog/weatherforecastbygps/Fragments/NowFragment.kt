...
class NowFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    var jsonWeatherNow = "http://api.openweathermap.org/data/2.5/weather?lat=48.8534&lon=2.3488&appid=467005a2981f9965ac02fa6dabd5fc2e"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      //  viewModelLongitude = ViewModelProviders.of(activity!!).get(LatitudeViewModel::class.java)
        ...
        viewModelLatitude.getStateLatitude().observe(this, Observer {
            ...
            jsonWeatherNow = "http://api.openweathermap.org/data/2.5/weather?lat=$lattitude&lon=$longgitude&appid=467005a2981f9965ac02fa6dabd5fc2e"
    ...
    private fun updateJsonWeatherNow(newLatitude: String) : String {
        jsonWeatherNow = "http://api.openweathermap.org/data/2.5/weather?lat=$newLatitude&lon=-0.4370218&appid=467005a2981f9965ac02fa6dabd5fc2e"
